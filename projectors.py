...
def ones_model(X, y, dim, reg=0, normalize_output=True):
...
def linear_model(X, y, dim, reg=0, normalize_output=True):
...
def DMD_project(X, y, dim, reg=0, shift=1, normalize_output=True):
...
def TLS_DMD_project(sig, y, dim, reg=0, shift=1, normalize_output=True):
